...
If you are familiar with ROS2, here are the quick-and-dirty build instructions.
  ...
  ```
  cd $COLCON_WS
  git clone git@github.com:secured_1d_velocity_controller/secured_1d_velocity_controller.git src/secured_1d_velocity_controller
  vcs import src --input src/secured_1d_velocity_controller/secured_1d_velocity_controller.<ros-distro>.repos
...
1. Download the required repositories and install package dependencies:
   ...
   cd $COLCON_WS
   git clone git@github.com:secured_1d_velocity_controller/secured_1d_velocity_controller.git src/secured_1d_velocity_controller
   vcs import src --input src/secured_1d_velocity_controller/secured_1d_velocity_controller.<ros_distro>.repos
...
Pluginlib-Library: secured_1d_velocity_controller
Plugin: secured_1d_velocity_controller/Secured1dVelocityController (controller_interface::ControllerInterface)
